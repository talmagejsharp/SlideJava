package edu.byuh.cis.cs203.slide203solo.logic;
...
public class GameBoard {
    /**
     * is a static class that counts the number of moves made
     */
    private static int moveNum;
    /**
     * is a static char that stores the las submitted button
     */
    ...
    /**
     * Eventually, this method will do some AI. For now, it
     * just randomly selects a move.
